...
a = Analysis(
    ...
    datas=[
        ...
        (os.path.join(PROJECT_ROOT, 'lightrag_index', 'input'), 'lightrag_index/input'),
        (os.path.join(PROJECT_ROOT, 'lightrag_index', 'lightrag_output'), 'lightrag_index/lightrag_output'),
        *_extra_datas,
        *_rapidocr_datas,
        *_tiktoken_ext_datas,
    ],
